const { YOUTUBE_SCOPE, requiredEnv, redirectUri, cookieOptions, randomId, signState } = require('../lib/youtube-oauth.js');
...
module.exports = async function handler(req, res) {
  ...
  } catch (e) { console.error(e); return res.status(500).json({ error: e.message || 'Could not start Google OAuth' }); }
};
